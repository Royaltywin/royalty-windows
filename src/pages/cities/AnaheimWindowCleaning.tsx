...
const AnaheimWindowCleaning = () => {
  const content = cityWindowCleaningContent["anaheim"];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        url="https://getroyaltyservices.com/window-cleaning/anaheim"
        type="LocalBusiness"
      />
      <Header />
      ...
      <main className="container mx-auto px-4 md:px-8 py-16 space-y-16">
        <section className="text-center max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-2 text-accent mb-4">
            ...
            <span className="text-lg font-semibold">Anaheim, Orange County</span>
          </div>
        ...
        <section className="max-w-4xl mx-auto">
          <div className="rounded-2xl overflow-hidden border-2 border-border" style={{ height: "400px" }}>
            <iframe 
              src="https://maps.google.com/?q=Anaheim,+CA&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
        ...
        <section id="quote" className="max-w-4xl mx-auto">
          <ServiceBookingForm serviceName="Window Cleaning in Anaheim" />
        </section>
      </main>

...
const AlisoViejoWindowCleaning = () => {
  const content = cityWindowCleaningContent["aliso-viejo"];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        url="https://getroyaltyservices.com/window-cleaning/aliso-viejo"
        type="LocalBusiness"
      />
      <Header />
      ...
      <main className="container mx-auto px-4 md:px-8 py-16 space-y-16">
        ...
        <section className="text-center max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-2 text-accent mb-4">
            ...
            <span className="text-lg font-semibold">Aliso Viejo, Orange County</span>
          </div>
        ...
        <section className="max-w-4xl mx-auto bg-accent/10 rounded-3xl p-8 md:p-12 border-2 border-accent/20">
          <h2 className="text-3xl md:text-4xl font-black text-foreground mb-8 text-center">
            Why Choose Royalty Window Cleaning Aliso Viejo
          </h2>
        ...
        {content.nearbyAreas && (
          <section className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-black text-foreground mb-6 text-center">
              Areas We Serve Near Aliso Viejo
            </h2>
        ...
        <section className="max-w-4xl mx-auto">
          <div className="rounded-2xl overflow-hidden border-2 border-border" style={{ height: "400px" }}>
            <iframe 
              src="https://maps.google.com/?q=Aliso+Viejo,+CA&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
        ...
        <section id="quote" className="max-w-4xl mx-auto">
          <ServiceBookingForm serviceName="Window Cleaning in Aliso Viejo" />
        </section>
      </main>
